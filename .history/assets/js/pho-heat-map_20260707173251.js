...
function initializeMap() {
    ...
    // CRITICAL LAYER LAYER FIX: Create a dedicated topmost visual pane for the 3KM rings
...
function drawHeatmap(data) {
    ...
    data.forEach(function(row) {
        ...
        // FIXED: Added the 'pane' option to explicitly push this layer into our top custom pane layer container
