...
/* LOAD DATA FROM FIRESTORE - ORDERED BY DOCUMENT ORDER */
async function loadCases() {
    ...
    try {
        console.log("🔄 Loading cases from rabies_cases collection (ordered by document)...");
        
        // Query ordered by documentOrder to preserve upload order
        const q = query(collection(db, "rabies_cases"), orderBy("documentOrder", "asc"));
        ...
        snapshot.forEach((doc) => {
            ...
            allCases.push({
                ...
                // Age
                ageLt15: Number(data.ageLessThan15 || 0),
                ageGt15: Number(data.ageGreaterThan15 || 0),
        ...
        console.log(`✅ Loaded ${allCases.length} facility records in document order`);
        renderTable();
...
function renderTable() {
    ...
    let totals = {
        ...
        compII: 0, compIII: 0, incII: 0, incIII: 0, noneII: 0, noneIII: 0, rep: 0
    };
