...
function renderTable() {
    ...
    tbody.innerHTML += `
        <tr style="background-color: #FFE3B3; font-weight: bold; border-top: 2px solid #EA6113; position: sticky; bottom: 0; z-index: 5;">
            ...
            <td>${totals.castrated}</td>
            <td>${totals.spayed}</td>
            <td>${totals.headSamples}</td>
            <td>${totals.rabiesPositive}</td>
            <td>${totals.rabiesNegative}</td>
            <td>${totals.humanDeath}</td>
        </tr>
    `;
