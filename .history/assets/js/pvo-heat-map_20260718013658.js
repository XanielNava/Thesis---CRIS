...
document.addEventListener("DOMContentLoaded", async () => {
    initializeMap();
    initializeControls();
    fetchPopulationDataFromFirestore(); // Real-time listener handles its own UI updates
...
// Real-time snapshot listener tailored for single province master total document
        ...
        onSnapshot(populationCollection, (querySnapshot) => {
            ...
            querySnapshot.forEach((doc) => {
                ...
                if (doc.id === "ILOILO_TOTAL") {
                    ...
                    // Fallback to safely track individual row properties if you decide to load them later
