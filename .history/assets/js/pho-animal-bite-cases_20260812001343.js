...
if (excelBtn) {
    excelBtn.addEventListener("click", () => {
        ...
        const wb = XLSX.utils.table_to_book(table, { sheet: "Animal Bite Cases" });
        XLSX.writeFile(wb, `PHO_Animal_Bite_Cases_${new Date().toISOString().split('T')[0]}.xlsx`);
    });
}
