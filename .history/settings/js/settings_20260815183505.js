...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (phoLogoInput) {
        phoLogoInput.addEventListener("change", async (e) => {
            ...
            try {
                // Compress & process image to prevent Firestore doc limits
                processedLogoBase64 = await resizeAndCompressImage(file, 400, 400, 0.85);
            } catch (err) {
                console.error("Image processing error:", err);
                alert("Failed to process image file. Please try another logo.");
            }
        });
    }
    ...
    return new Promise((resolve, reject) => {
        ...
        reader.onload = async (e) => {
            try {
                ...
                // Chunk batch writes to prevent exceeding Firestore 500-op limit
...
// Comprehensive Document ID Sanitization
