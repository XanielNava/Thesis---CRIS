            ...
            reader.onload = async (e) => {
                try {
                    ...
                    for (let i = 3; i < rawRows.length; i++) {
                        ...
                        // Extracted only facilityName and totalPopulation
                        cleanData.push({
                            facilityName,
                            totalPopulation: parseNumber(row[2])
                        });
                    }
                    ...
                    addHistoryRow(dateString, selectedFile.name, `${cleanData.length} Municipalities (Population)`, "Completed");
