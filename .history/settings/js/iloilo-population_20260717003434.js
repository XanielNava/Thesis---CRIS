...
function initializeEventListeners() {
    // Safety guard to ensure the elements exist on the page before binding
    if (!fileInput || !uploadZone || !browseBtn) {
        console.warn("⚠️ Population import UI elements missing on this page. Skipping initialization.");
        return;
    }
...
function handleFileSelection() {
    ...
    if (file && fileNameSpan && fileSizeSpan && fileInfo && importBtn) {
        selectedFile = file;
...
// =========================================================================
// 6. Execution Block (Runs immediately since script is placed at bottom)
// =========================================================================
