...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function handleFileSelection(e) {
        ...
        reader.onload = function(evt) {
            try {
                ...
                // ✅ NEW: Add clear button event listener for the 'X' mark
                const clearBtn = uploadLabel.querySelector('#clearFileBtn');
                clearBtn.addEventListener('click', (e) => {
                    e.preventDefault();
                    resetToEmptyState(); // This clears the file and makes the UI revert
                });
    ...
    function resetToEmptyState() {
        ...
        // Restore original UI state safely (Makes the file disappear)
        uploadLabel.innerHTML = defaultLabelText;
        if (fileInput) {
            fileInput.value = ''; // Safely clears the native file input value
        }
