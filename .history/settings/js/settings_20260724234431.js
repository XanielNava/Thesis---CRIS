...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function initImportSection({ cardTitle, fileInputId, collectionName, dataType }) {
        ...
        // ====================================================================
        // FIND CARD BY FILE INPUT ID (More Reliable)
        // ====================================================================
    ...
    initImportSection({
        ...
        collectionName: "pho_rabies_cases",
        dataType: "cases"
    });
    ...
    initImportSection({
        cardTitle: "Import Total Annual Bite Cases Dataset",
        fileInputId: "animalbitecasesDataFile",
        collectionName: "pho_total_annual_bite_cases",
        dataType: "animalbitecases"
    });
