        ...
        function handleFileSelection(event) {
            ...
            reader.onload = function (e) {
                try {
                    ...
                    // The source file only writes "District" on the FIRST municipality
                    // row of each group (1st, 2nd, 3rd...) and leaves it blank for every
                    // row after that. This tracker carries the last real value forward
                    // so every row gets the correct district instead of "N/A".
                    ...
                    for (let rowIndex = 3; rowIndex < rawRows.length; rowIndex++) {
                        ...
                        // Column 0: District - carry forward if this row's cell is blank
                        ...
                        if (dataType === "cases") {
                            cleanData.push({
                                district: district,                      // Column 0 (forward-filled)
