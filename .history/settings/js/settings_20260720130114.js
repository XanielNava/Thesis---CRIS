        ...
        function handleFileSelection(e) {
            ...
            reader.onload = function (evt) {
                try {
                    ...
                    // =====================================================================
                    // FIX: Create file info section with X button explicitly
                    // =====================================================================
                    const fileInfoHTML = `
                        ...
                        <div style="
                            ...
                            gap: 8px;
                        ">
                            <div style="flex: 1; min-width: 0; padding-right: 8px; overflow: hidden;">
                            ...
                            <button type="button" class="file-clear-trigger-btn" style="
                                background: #D32F2F;
                                color: white;
                                border: none;
                                padding: 6px 10px;
                    ...
                    uploadLabel.innerHTML = fileInfoHTML;

                    // Bind active trigger handlers to the locally scoped custom buttons
                    // Using setTimeout to ensure DOM is ready
                    setTimeout(() => {
                        const changeBtn = cardElement.querySelector('.file-change-trigger-btn');
                        const clearBtn = cardElement.querySelector('.file-clear-trigger-btn');
                        ...
                        if (clearBtn) {
                            ...
                            console.warn(`Clear button not found in ${cardTitle}`);
                        }
                    }, 0);
